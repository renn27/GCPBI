...
class RekapWilayahExport implements FromCollection, WithHeadings, WithMapping, WithStyles
{
    protected $importId;
    ...
    public function collection()
    {
        return DB::table('assignments')
            ...
            ->groupBy('wilayah.level_3_code', 'wilayah.level_3_name', 'wilayah.level_4_code', 'wilayah.level_4_name')
            ->orderBy('kecamatan')
            ->orderBy('desa')
            ->get();
    }
